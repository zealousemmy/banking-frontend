              ...
              <div className="row align-items-center justify-content-between">
                ...
                <div className="col-md-6">
                  <div className="section-area">
                    ...
                    <p>
                      Unlimited virtual cards that you can issue to each
                      employee, merchant, or use-case. Say goodbye to sharing
                      cards or one-time passwords, and hello to faster
                      purchasing. All for free.
                    </p>
                  </div>
                </div>
              </div>
