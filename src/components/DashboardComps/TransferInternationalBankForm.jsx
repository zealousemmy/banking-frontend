...
const TransferInternationalBankForm = ({ handleClick }) => {
  ...
  const validate = () => {
    ...
    if (!transferData.swiftCode) newErrors.country = "switf code is required";
            ...
            <form action="#">
              <div className="send-banance">
                ...
                {errors.accountNumber && (
                  <p className="text-danger mb-4 ">{errors.accountNumber}</p>
                )}
                ...
                <span className="mdr">Swift code</span>
                <div className="input-area">
                  <input
                    className="xxlr"
                    placeholder={9099}
                ...
                {errors.swiftCode && (
                  <p className="text-danger mb-4 ">{errors.swiftCode}</p>
                )}
                ...
                {errors.routingNumber && (
                  <p className="text-danger mb-4 ">{errors.routingNumber}</p>
                )}
                ...
                <span className="mdr">Iban: (optional)</span>
                <div className="input-area">
                  <input
                    onChange={handleChange}
                    value={transferData.ibanNumber}
                    name="ibanNumber"
                    className="xxlr"
                    placeholder={"iban"}
                    type="text"
