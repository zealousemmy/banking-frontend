              ...
              <div className="row cus-mar align-items-center">
                ...
                <div className="col-lg-4 col-sm-6">
                  <div className="single-box">
                    ...
                    <div className="body-area">
                      <h5>Leo Nunez</h5>
                      <p className="designation">VP of Product</p>
                      <div className="social-link d-flex justify-content-center align-items-center">
                        <a href="javascript:void(0)">
                          <img
                            src="assets/images/icon/facebook.png"
                ...
                <div className="col-lg-4 col-sm-6">
                  <div className="single-box">
                    ...
                    <div className="body-area">
                      <h5>Billy Roy</h5>
                      <p className="designation">VP of Infrastructure</p>
                      <div className="social-link d-flex justify-content-center align-items-center">
                        <a href="javascript:void(0)">
                          <img
                            src="assets/images/icon/facebook.png"
                ...
                <div className="col-xl-8">
                  <div className="section-header text-center">
                    ...
                    <p>
                      ...
                      diam malesuada nisl enim phasellus condimentum.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="email-phone">
                      ...
                      <p>
                        <a
                          ...
                          data-cfemail="2f5c4e41495d4e414c465c4c406f5f4e56434640014c4042"
                        >
                          [email&nbsp;protected]
                        </a>
                      </p>
                    ...
                    <div className="email-phone">
                      ...
                      <p>
                        <a
                          href="https://pixner.net/cdn-cgi/l/email-protection"
                          className="__cf_email__"
                          data-cfemail="e9878c9e90869b82a9998890858086c78a8684"
                        >
                          [email&nbsp;protected]
                        </a>
                      </p>
                    ...
                    <div className="email-phone">
                      ...
                      <p>
                        <a
                          href="https://pixner.net/cdn-cgi/l/email-protection"
                          className="__cf_email__"
                          data-cfemail="bdd1d2d3d9d2d3fdcddcc4d1d4d293ded2d0"
                        >
                          [email&nbsp;protected]
                        </a>
                      </p>
